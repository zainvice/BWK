  ...
  return (
    <div className={styles.tearmsAndConditions}>
      ...
      <div className={styles.pleaseReadTheseContainer}>
        ...
        <p
          className={styles.pleaseReadThese}
        >{`                                a. Users can subscribe to different levels (Bronze, Silver, Gold, Platinum, VIP) by paying the corresponding charges. `}</p>
        <p
          className={styles.pleaseReadThese}
        >{`                                b. Subscription fees are non-refundable and non-transferable.  `}</p>
        <p
          className={styles.pleaseReadThese}
        >{`                                c. We reserve the right to modify the subscription charges at any time, and such changes will be effective                                                `}</p>
        <p
          className={styles.pleaseReadThese}
        ...
        <p
          className={styles.pleaseReadThese}
        >{`                               a. We reserve the right to modify or update these Terms and Conditions at any time without prior notice. b. Users `}</p>
        <p
          className={styles.pleaseReadThese}
        >{`                                   are responsible for reviewing the Terms and Conditions periodically for any changes. `}</p>
        <p
          className={styles.pleaseReadThese}
